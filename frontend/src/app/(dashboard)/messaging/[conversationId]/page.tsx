...
import { ArrowLeft, Send, User, Bot, Clock, MoreHorizontal } from "lucide-react";
...
const MOCK_MESSAGES: Message[] = [
  { id: "m-1", sender: "auto", text: "Hi! Thanks for reaching out. Our team typically responds within 15 minutes during business hours.", timestamp: "2026-02-20T10:00:00Z" },
  { id: "m-2", sender: "user", text: "Hi there! I placed an order 3 days ago (Order #TTS-28491) and haven't received any shipping updates yet.", timestamp: "2026-02-20T10:02:00Z" },
  { id: "m-3", sender: "merchant", text: "Hello Sarah! Let me look into that for you right away.", timestamp: "2026-02-20T10:05:00Z" },
  { id: "m-4", sender: "merchant", text: "I found your order. It looks like it was shipped yesterday and the tracking info should update within 24 hours. Your tracking number is TK-992847381.", timestamp: "2026-02-20T10:07:00Z" },
  { id: "m-5", sender: "user", text: "Oh great, thank you! Do you know the estimated delivery date?", timestamp: "2026-02-20T10:10:00Z" },
  { id: "m-6", sender: "merchant", text: "Based on your location, you should receive it within 3-5 business days. So approximately by February 25th.", timestamp: "2026-02-20T10:12:00Z" },
  { id: "m-7", sender: "user", text: "Perfect, that works! One more question - can I add another item to this order?", timestamp: "2026-02-20T10:15:00Z" },
];
...
export default function ConversationDetailPage() {
  ...
  return (
    <PageShell
      aside={
        <InsightPanel>
          <InsightItem title="Customer profile" description={`${MOCK_USER.name} - ${MOCK_USER.totalOrders} orders since ${new Date(MOCK_USER.joinedAt).toLocaleDateString()}`} />
          <InsightItem title="Suggested reply" description="The customer is asking about adding items. Standard policy: items cannot be added once shipped." variant="default" />
        </InsightPanel>
      }
    >
      {/* Header */}
      <div className="flex items-center gap-4 mb-6">
        ...
        <div className="flex items-center gap-3 flex-1">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500">{MOCK_USER.totalOrders} orders | Customer since {new Date(MOCK_USER.joinedAt).toLocaleDateString()}</p>
          </div>
        </div>
