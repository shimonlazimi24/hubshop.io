				...
				<AnimatePresence>
					{unreadCount > 0 && (
						...
						>
							...
							{/* Pulse ring */}
							<span className="absolute inset-0 rounded-full bg-coral animate-ping opacity-40" />
						</motion.span>
					)}
				</AnimatePresence>
			</button>
							...
							<div className="flex items-center gap-2">
								{unreadCount > 0 && (
									<>
										...
										<button
											onClick={markAllRead}
											className="flex items-center gap-1 text-[11px] font-medium text-foreground-secondary hover:text-foreground transition-colors"
						...
						<div className="max-h-80 overflow-y-auto">
							{notifications.length === 0 ? (
								<div className="flex flex-col items-center justify-center py-10 px-4">
									...
									<p className="text-xs text-foreground-secondary opacity-60 mt-1">
									...
									{notifications.map((notif) => {
										...
										return (
											<motion.button
												...
												className={cn(
													"flex w-full gap-3 px-4 py-3 text-left hover:bg-surface transition-colors",
											...
											>
												...
												<div className="min-w-0 flex-1">
													...
													<p className="text-[10px] text-foreground-secondary opacity-60 mt-1">
