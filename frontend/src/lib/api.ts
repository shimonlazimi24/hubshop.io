...
interface FetchOptions extends RequestInit {
	token?: string;
	/** Skip the automatic 401 refresh-and-retry logic (used internally). */
...
async function apiFetch<T>(
	...
	const { token, _skipRefresh, headers: customHeaders, ...rest } = options;
	...
	if (response.status === 401 && !_skipRefresh && !isRefreshing) {
		...
		if (refreshToken) {
			...
			try {
				...
				// Refresh itself failed -- clear auth and redirect to login
				clearTokens();
...
export function getAuthorizeUrl(
	...
	return apiFetch(
		`/connect/${platform}/authorize?workspace_id=${workspaceId}`,
		{ token },
	);
}
...
export function listSyncJobs(
	...
	return apiFetch(
		`/connect/sync/jobs?workspace_id=${workspaceId}&limit=${limit}`,
		{ token },
	);
}
...
export function getActiveSyncJobs(
	...
	return apiFetch(`/connect/sync/active?workspace_id=${workspaceId}`, {
		token,
	});
}
...
export function triggerManualSync(
	...
	return apiFetch(
		`/connect/sync/trigger?workspace_id=${workspaceId}&platform=${platform}`,
		{
			method: "POST",
			token,
		},
...
export function syncProducts(
	...
	return apiFetch(`/commerce/products/sync?${query}`, {
		method: "POST",
		token,
	});
}
...
export function createCustomAudience(
	...
	return apiFetch("/ads/audiences/custom", {
		method: "POST",
		body: JSON.stringify(data),
		token,
	});
...
export function createLookalikeAudience(
	...
	return apiFetch("/ads/audiences/lookalike", {
		method: "POST",
		body: JSON.stringify(data),
		token,
	});
...
export function addProductsToCatalog(
	...
	return apiFetch(`/ads/catalogs/${catalogId}/products`, {
		method: "POST",
		body: JSON.stringify(data),
		token,
	});
...
export function syncVideos(
	...
	return apiFetch(`/content/videos/sync?workspace_id=${workspaceId}`, {
		method: "POST",
		token,
	});
}
...
export function getCreatorInfo(
	...
	return apiFetch(`/content/creator-info?workspace_id=${workspaceId}`, {
		token,
	});
}
...
export function getPublishStatus(
	...
	return apiFetch(
		`/content/publish/${publishId}/status?workspace_id=${workspaceId}`,
		{ token },
	);
}
...
export function getCalendar(
	...
	return apiFetch(
		`/content/calendar?workspace_id=${workspaceId}&year=${year}&month=${month}`,
		{ token },
	);
}
...
export function addToMarketplace(
	...
	return apiFetch("/commerce/affiliate/marketplace/add", {
		method: "POST",
		body: JSON.stringify(data),
		token,
	});
...
export function removeFromMarketplace(
	productId: string,
	shopId: string,
	token: string,
): Promise<void> {
	return apiFetch(
		`/commerce/affiliate/marketplace/remove?product_id=${productId}&shop_id=${shopId}`,
		{
			method: "POST",
			token,
		},
...
export function createOpenCollaboration(
	...
	return apiFetch("/commerce/affiliate/collaborations/open", {
		method: "POST",
		body: JSON.stringify(data),
		token,
	});
...
export function createTargetCollaboration(
	...
	return apiFetch("/commerce/affiliate/collaborations/target", {
		method: "POST",
		body: JSON.stringify(data),
		token,
	});
...
export function createPromotion(
	...
	return apiFetch("/commerce/promotions", {
		method: "POST",
		body: JSON.stringify(data),
		token,
	});
...
export function deactivatePromotion(
	...
	return apiFetch(`/commerce/promotions/${promotionId}/deactivate`, {
		method: "POST",
		token,
	});
}
...
export function syncPromotions(
	...
	return apiFetch(
		`/commerce/promotions/sync?workspace_id=${workspaceId}&shop_id=${shopId}`,
		{
			method: "POST",
			token,
		},
...
export function listConversations(
	...
	return apiFetch(
		`/commerce/conversations?workspace_id=${workspaceId}&shop_id=${shopId}`,
		{ token },
	);
}
...
export function listCreatorProfiles(
	...
	if (params?.is_saved !== undefined)
		query.set("is_saved", String(params.is_saved));
...
export function saveCreator(
	creatorId: string,
	isSaved: boolean,
	token: string,
): Promise<CreatorSummary> {
	return apiFetch(`/creators/profiles/${creatorId}/save?is_saved=${isSaved}`, {
		method: "POST",
		token,
	});
}
...
export function getCreatorCampaign(
	campaignId: string,
	token: string,
): Promise<CreatorCampaign> {
...
export function listInvitations(
	...
	if (params?.status_filter) query.set("status_filter", params.status_filter);
	return apiFetch(`/creators/campaigns/${campaignId}/invitations?${query}`, {
		token,
	});
}
...
export function getContentPerformance(
	...
	return apiFetch(
		`/analytics/content-performance?workspace_id=${workspaceId}`,
		{ token },
	);
}
...
export function getPlatformHealth(
	...
	return apiFetch(`/analytics/platform-health?workspace_id=${workspaceId}`, {
		token,
	});
}
...
export function createScheduledReport(
	...
	return apiFetch(`/analytics/reports?workspace_id=${workspaceId}`, {
		method: "POST",
		body: JSON.stringify(data),
		token,
	});
...
export function generateReport(
	...
	return apiFetch(`/analytics/reports/${reportId}/generate`, {
		method: "POST",
		token,
	});
}
...
export function deleteScheduledReport(
	...
	return apiFetch(`/analytics/reports/${reportId}`, {
		method: "DELETE",
		token,
	});
}
...
export function getUnreadCount(
	...
	return apiFetch(
		`/analytics/notifications/unread-count?workspace_id=${workspaceId}`,
		{ token },
	);
}
...
export function markNotificationRead(
	...
	return apiFetch(`/analytics/notifications/${notificationId}/read`, {
		method: "POST",
		token,
	});
}
...
export function markAllNotificationsRead(
	...
	return apiFetch(
		`/analytics/notifications/read-all?workspace_id=${workspaceId}`,
		{ method: "POST", token },
	);
}
...
export function updateNotificationPreference(
	...
	return apiFetch("/analytics/notifications/preferences", {
		method: "PUT",
		body: JSON.stringify(data),
		token,
	});
...
export function createApiKey(
	...
	return apiFetch(`/analytics/api-keys?workspace_id=${workspaceId}`, {
		method: "POST",
		body: JSON.stringify(data),
		token,
	});
...
export function listAutoMessages(
	...
	return apiFetch(
		`/messaging/auto-messages?connected_account_id=${connectedAccountId}`,
		{ token },
	);
}
