...
import { Order202406SearchOrderByExternalOrderReferenceResponse } from '../model/order/V202406/SearchOrderByExternalOrderReferenceResponse';
...
export class OrderV202406Api {
     ...
     * @param shopCipher 
     */
    public async OrdersExternalOrderSearchPost (platform: string, externalOrderId: string, xTtsAccessToken: string, contentType: string, shopCipher?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Order202406SearchOrderByExternalOrderReferenceResponse;  }> {
        ...
        if (externalOrderId !== undefined) {
            localVarQueryParameters['external_order_id'] = ObjectSerializer.serialize(externalOrderId, "string");
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: Order202406SearchOrderByExternalOrderReferenceResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "Order202406SearchOrderByExternalOrderReferenceResponse");
...
export type OrderV202406ApiOperationTypes = {
    OrdersExternalOrderSearchPost: OrderV202406Api['OrdersExternalOrderSearchPost'];OrdersExternalOrdersPost: OrderV202406Api['OrdersExternalOrdersPost'];OrdersOrderIdExternalOrdersGet: OrderV202406Api['OrdersOrderIdExternalOrdersGet'];
};
